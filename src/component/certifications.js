...
const Certifications = ({ title, caducidad, credential }) => {
  return (
    <>
      <Box pl={3}>
        <StaticImage width={56} src="https://media-exp1.licdn.com/dms/image/C4E0BAQGLKj3JHcof0w/company-logo_100_100/0/1589990867649?e=1647475200&v=beta&t=JNDcOStsdmisTC5kgoBrMHLzQfKWu-86qs3ZgiMavFk" />
      </Box>
      <StatGroup pl={9}>
        <Stat>
